    ...
    <div className="h-full bg-gray-900">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start">
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            width={500}
            height={300}
            className="rounded-lg max-w-md sm:w-auto"
            priority
          />
        </div>
        <div className="md:w-1/2 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center md:text-center">
          <h2 className="text-4xl hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.9)] transition-all duration-300 ease-in-out rounded-full">
            Maximize Your Learning
          </h2>
          {/* Increased font size */}
          <p className="mt-4 sm:text-align-center sm:mr-12 sm:ml-12 text-lg ">
            Note Distillery — your smart tool for turning handwritten or printed
            notes into clean, editable content. Just upload an image, and our AI
            extracts and organizes the text — even complex math. Study smarter
            with searchable, structured notes that help you stay focused and
            retain more.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <p className="mt-4 sm:text-align-center text-lg ">
          With Note Distillery, you can focus on what truly matters. Our
          intuitive platform ensures that your notes are always accessible,
          organized, and ready for action. Whether you&apos;re a student,
          professional, or lifelong learner, our tools are designed to help you
          achieve your goals effortlessly. Experience the future of note-taking
          today.
        </p>
      </div>
      ...
      {/* Login Section */}
      <Link
        href={user ? "/zone" : "/login"}
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 text-center"
      >
        <h2 className="text-3xl font-bold mb-6 hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.9)] transition-all duration-300 ease-in-out rounded-full">
          Login to Enter <br />
          &quot;The Zone&quot;
        </h2>
        <p className="mt-4">
          Ready to transform your notes? Login now to begin your journey with
          Note Distillery.
        </p>
      </Link>
