  ...
  switch (action.type) {
    ...
    case "content_uploaded":
      ...
      toReturn = {
        ...uploadState,
        extractedContent:
          action.extractedContent ?? uploadState.previewedContent,
        showContentPreviewer: true,
        showCreateNote: false,
        showFolderCreator: false,
        showFolderSelector: false,
        processing: true,
        actionHistory: action.fromGoBack
          ? [...uploadState.actionHistory]
          : [...uploadState.actionHistory, action.type],
      };
      break;
    ...
    case "content_previewed": {
      ...
      toReturn = {
        ...uploadState,
        previewedContent:
          action.previewedContent ?? uploadState.newNoteObj.content,
        newNoteObj: {
          ...tempNoteObj,
        },
        showContentPreviewer: false,
    ...
    case "go_back": {
      ...
      const targetState =
        uploadState.actionHistory[uploadState.actionHistory.length - 2];
